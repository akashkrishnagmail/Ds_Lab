...
set group [Node allocaddr] ;# allocate a multicast adress
#===================================
#        Nodes Definition        
#===================================
#Create 5 nodes
...
set mproto DM ;
set mrthandle [$ns mrtproto $mproto] ;# all node will be multicast agent
#===================================
#        Agents Definition        
#===================================
...
set rcvr [new Agent/LossMonitor] ;#create a recever agent
$ns attach-agent $n1 $rcvr
$ns at 1.9 "$n1 join-group $rcvr $group"

set rcvr2 [new Agent/LossMonitor] ;#create a recever agent
$ns attach-agent $n2 $rcvr2
$ns at 1.12 "$n2 join-group $rcvr2 $group"

set rcvr3 [new Agent/LossMonitor] ;#create a recever agent
$ns attach-agent $n3 $rcvr3
$ns at 1.15 "$n3 join-group $rcvr3 $group"

set rcvr4 [new Agent/LossMonitor] ;#create a recever agent
